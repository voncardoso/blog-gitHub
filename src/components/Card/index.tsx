...
export const Card: FunctionComponent<CardProps> = ({time, title, description}) => {
    return (
        <div className="bg-base-post rounded-md shadow-lg p-8 w-full max-w-[418px] h-[260px]  hover:border hover:border-base-label transition duration-700 ease-in-out">
